...
class AppColors {
  static final Color primary = Color(0xFF8698e5); // 0xFFA5452E
  static final Color secondary = Color(0xFFCCCD43);
  static final Color tertiary = Color(0xFF274769);

  static final Color buttonColor = Color(0xFFCCCD43);
  static final Color buttonText = Color(0xFF274769);

  // PetDigital
  static final Color backgroundFill = Color(0xFFA5452E);
  //static final Color backgroundFill = Color(0xFF57B6E5);
  //static final Color backgroundFill = Color(0xFF8698e5);

  static final Color orange = Color(0xFFFF9000);
  static final Color myWhite = Color(0xFFF4EDE8);
  static final Color myGrey = Color(0xFFB7B7CC);
  static final Color myDarkGrey = Color(0xFFF0F0F5);
  static final Color myBlack = Color(0xFF514766);
